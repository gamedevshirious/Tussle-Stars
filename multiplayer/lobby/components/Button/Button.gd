...
#func set_size(new_size, x=false) :
#	size = new_size
#	var font
#	if size == 0:
#		font = preload("res://multiplayer/lobby/resources/fonts/RobotoLight-32px.tres")
#	else:
#		font = preload("res://multiplayer/lobby/resources/fonts/RobotoLight-64px.tres")
#
